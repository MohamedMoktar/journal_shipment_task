		...
		<div class="d-flex flex-column flex-root">
			...
			<div class="d-flex flex-column flex-column-fluid bgi-position-y-bottom position-x-center bgi-no-repeat bgi-size-contain bgi-attachment-fixed" style="background-image: url('{{ assetsMetronic('media/illustrations/development-hd.png') }}')">
				...
				<div class="d-flex flex-column flex-column-fluid text-center p-10 py-lg-20">
					...
					<div class="pt-lg-10">
						<!--begin::Logo-->
						<h1 class="fw-bolder fs-4x text-gray-800 mb-10">{{ __('System Error') }}</h1>
						<!--end::Logo-->
						<!--begin::Message-->
						<div class="fw-bold fs-3 text-muted mb-15">{{ __('Something went wrong!') }}
						<br />{{ __('Please try again later.') }}</div>
						<!--end::Message-->
						<!--begin::Action-->
